...
public class ArticleTest {
	...
	public void test002_EmptyArgumentConstructor() {
		...
		assertEquals( e.getId(), "" );	// assert that correct id is returned
		assertSame( e.getId(), "" );		// "==" - equivalent
		
		assertEquals( e.getDescription(), "");
		assertSame( e.getDescription(), "");
	...
	public void test003_NullArgumentConstructor() {
		...
		assertEquals( e.getId(), null );	// assert that correct id is returned
		assertSame( e.getId(), null );		// "==" - equivalent
